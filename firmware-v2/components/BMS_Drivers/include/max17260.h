 ...
 * Registers device on the I2C bus, handles POR detection and
 * ModelGauge m5 EZ initialization.
 */
esp_err_t max17260_init(i2c_master_bus_handle_t bus_handle, const MAX17260Config* config);

/** Quick I2C health check — reads STATUS register to verify communication */
