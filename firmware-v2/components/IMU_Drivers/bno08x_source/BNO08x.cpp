...
esp_err_t BNO08x::init_hint_isr()
{
    ...
    // ISR service is installed by BSP — no need to install here
    init_status.isr_service = true;
...
esp_err_t BNO08x::init_spi()
{
    ...
    // SPI bus is initialized by BSP — just add the IMU device to the shared bus
...
esp_err_t BNO08x::deinit_hint_isr()
{
    ...
    // ISR service is owned by BSP — do not uninstall here
...
esp_err_t BNO08x::deinit_spi()
{
    ...
    // SPI bus is owned by BSP — do not free it here
