...
const acc_reg_protocol_t ref_app_breathing_reg_protocol[REF_APP_BREATHING_REG_REGISTER_COUNT] = {
    ...
    {
        REF_APP_BREATHING_REG_HEART_RATE_ADDRESS,  // heart_rate address
        ref_app_breathing_reg_read_heart_rate,     // heart_rate read access function
        NULL,
    },
    {
        REF_APP_BREATHING_REG_HEART_RATE_CONFIDENCE_ADDRESS,  // heart_rate_confidence address
        ref_app_breathing_reg_read_heart_rate_confidence,     // heart_rate_confidence read access function
        NULL,
    },
    {
        REF_APP_BREATHING_REG_DETECTED_DISTANCE_ADDRESS,      // detected_distance address
        ref_app_breathing_reg_read_detected_distance,         // detected_distance read access function
        NULL,
    },
    {
    ...
    {
        REF_APP_BREATHING_REG_RAW_DATA_LENGTH_ADDRESS,  // raw_data_length address
        ref_app_breathing_reg_read_raw_data_length,     // raw_data_length read access function
        NULL,
    },
    {
