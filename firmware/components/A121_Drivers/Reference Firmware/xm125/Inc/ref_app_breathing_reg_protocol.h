...
#define REF_APP_BREATHING_REG_REGISTER_COUNT 26U
...
#define REF_APP_BREATHING_REG_HEART_RATE_ADDRESS 19U
#define REF_APP_BREATHING_REG_HEART_RATE_CONFIDENCE_ADDRESS 20U
#define REF_APP_BREATHING_REG_DETECTED_DISTANCE_ADDRESS 21U
...
#define REF_APP_BREATHING_REG_RAW_DATA_LENGTH_ADDRESS 77U
#define REF_APP_BREATHING_REG_COMMAND_ADDRESS 256U
#define REF_APP_BREATHING_REG_APPLICATION_ID_ADDRESS 65535U

// Raw Data Access Range
#define REF_APP_BREATHING_REG_RAW_DATA_START_ADDRESS 0x1000U
#define REF_APP_BREATHING_REG_RAW_DATA_END_ADDRESS   0x2000U
...
#define REF_APP_BREATHING_REG_COMMAND_ENUM_START_APP_MANUAL 4U
#define REF_APP_BREATHING_REG_COMMAND_ENUM_TRIGGER_FRAME 5U
...
/**
 * Read:
 * The heart rate. 0 if no heart rate available. Note: This
 * value is a factor 1000 larger than the RSS value.
 */
void ref_app_breathing_reg_read_heart_rate(uint32_t *value);


/**
 * Read:
 * The heart rate confidence.
 */
void ref_app_breathing_reg_read_heart_rate_confidence(uint32_t *value);


/**
 * Read:
 * The detected distance to the subject in millimeters.
 * Note: This value is a factor 1000 larger than the RSS value (meters).
 */
void ref_app_breathing_reg_read_detected_distance(uint32_t *value);
 ...
 */
void ref_app_breathing_reg_read_raw_data_length(uint32_t *value);
