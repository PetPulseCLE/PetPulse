...
/**
 * @brief Get the presence detector handle
 *
 * @param[in] handle The ref app breathing handle
 * @return The presence detector handle
 */
acc_detector_presence_handle_t *ref_app_breathing_get_presence_handle(ref_app_breathing_handle_t *handle);
