...
/**
 * Reload the key from NVS and rebuild the payload.
 * Call after findmy_keys_set() to pick up a new key without rebooting.
 *
 * @return ESP_OK or ESP_ERR_NOT_FOUND if no valid key
 */
